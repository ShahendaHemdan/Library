        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDarkDropdownMenuLink">
              <li><a class="dropdown-item" href="views/sciencefiction.php">Science Fiction</a></li>
              <li><a class="dropdown-item" href="views/psychology.php">Psychology</a></li>
              <li><a class="dropdown-item" href="views/horror.php">Horror</a></li>
              <li><a class="dropdown-item" href="views/Novel.php">Novel</a></li>
            </ul>
          </li>
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDarkDropdownMenuLink">
              ...
              <?php } else { ?>
                <li><a class="dropdown-item" href="views/SignIn.html">Log In</a></li>
                <li><a class="dropdown-item" href="views/SignUp.html">Sign Up</a></li>
              <?php } ?>
            </ul>
          </li>
          <?php if (isset($_SESSION['username'])) { ?>
          ...
          <?php } ?>
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="views/AboutUs.php">About Us</a>
          </li>
        </ul>
        <form class="d-flex" action="./views/searchfor.php" method="post">
          <input class="form-control me-2" type="search" name="search-key" placeholder="Search" aria-label="Search">
          <button class="btn btn-outline-success" type="submit" name="search-for" value="submit">Search</button>
        </form>
      </div>
    </div>
  </nav>
          ...
          <div class="card" style="width: 18rem;">
            ...
            <div class="card-body">
              ...
              <?php if (isset($_SESSION['username']) && $_SESSION['role'] === 'admin') { ?>
                ...
                <button type="button" class="btn btn-success"><a style="display: inherit;" href="./views/editData.php?edit_bookid=<?php echo $row['bookid']; ?>">UpdateBook</a></button>
              <?php } ?>
              <?php
